(function (global, factory) {
    ...
    function useFeatures(props, visualElement, preloadedFeatures) {
        ...
        for (var i = 0; i < numFeatures; i++) {
            ...
            if (isEnabled(props) && Component) {
                features.push(React__namespace.createElement(Component, __assign$2({ key: name_1 }, props, { visualElement: visualElement })));
            }
        }
        return features;
    }
    ...
    ***************************************************************************** */
    ...
    var alpha = __assign$1(__assign$1({}, number), { transform: clamp$1(0, 1) });
    ...
    var filter = __assign$1(__assign$1({}, complex), { getAnimatableNone: function (v) {
    ...
    ***************************************************************************** */
    ...
    function getAnimation(key, value, target, transition, onComplete) {
        ...
        function start() {
            ...
            return valueTransition.type === "inertia" ||
                ...
                : animate$1(__assign$2(__assign$2({}, getPopmotionAnimationOptions(valueTransition, options, key)), { onUpdate: function (v) {
                        var _a;
                        options.onUpdate(v);
    ...
    function setTarget(visualElement, definition) {
        ...
        var _a = resolved
            ...
            : {}, _b = _a.transitionEnd, transitionEnd = _b === void 0 ? {} : _b; _a.transition; var target = __rest$1(_a, ["transitionEnd", "transition"]);
    ...
    var Animate = /** @class */ (function (_super) {
        ...
        function Animate() {
            ...
            _this.animate = function (target, origin, _a) {
                if (_a === void 0) { _a = {}; }
                var originBox = _a.originBox, targetBox = _a.targetBox, visibilityAction = _a.visibilityAction, shouldStackAnimate = _a.shouldStackAnimate, onComplete = _a.onComplete, config = __rest$1(_a, ["originBox", "targetBox", "visibilityAction", "shouldStackAnimate", "onComplete"]);
    ...
    function AnimateLayoutContextProvider(props) {
        ...
        return React__namespace.createElement(Animate, __assign$2({}, props, { safeToRemove: safeToRemove }));
    }
    ...
    function MeasureContextProvider(props) {
        ...
        return (React__default['default'].createElement(Measure, __assign$2({}, props, { syncLayout: syncLayout, framerSyncLayout: framerSyncLayout })));
    }
    ...
    function createCrossfader() {
        ...
        function startCrossfadeAnimation(target, transition) {
            ...
            return animate(progress, target, __assign$2(__assign$2({}, transition), { onUpdate: function () {
    ...
    function layoutStack() {
        ...
        var prevState = __assign$2({}, state);
        var prevValues;
        var prevViewportBox;
        var prevDragCursor;
    ...
    var AnimateSharedLayout = /** @class */ (function (_super) {
        ...
        function AnimateSharedLayout() {
             ...
             */
            _this.syncContext = __assign$2(__assign$2({}, createBatcher()), { syncUpdate: function (force) { return _this.scheduleUpdate(force); }, forceUpdate: function () {
                    // By copying syncContext to itself, when this component re-renders it'll also re-render
                    // all children subscribed to the SharedLayout context.
                    _this.syncContext = __assign$2({}, _this.syncContext);
    ...
    function MotionConfig(_a) {
        var children = _a.children, config = __rest$1(_a, ["children"]);
        /**
         * Inherit props from any parent MotionConfig components
         */
        config = __assign$2(__assign$2({}, React.useContext(MotionConfigContext)), config);
        /**
     ...
     * @public
     */
    var domAnimation = __assign$2(__assign$2({ renderer: createDomVisualElement }, animations), gestureAnimations);

    /**
     * @public
     */
    var domMax = __assign$2(__assign$2(__assign$2({}, domAnimation), drag), layoutAnimations);
    ...
    function transform() {
        ...
        var interpolator = interpolate(inputRange, outputRange, __assign$2({ mixer: getMixer(outputRange[0]) }, options));
    ...
    function useSpring(source, config) {
        ...
        React.useMemo(function () {
            return value.attach(function (v, set) {
                ...
                activeSpringAnimation.current = animate$1(__assign$2(__assign$2({ from: value.get(), to: v, velocity: value.getVelocity() }, config), { onUpdate: set }));
                return value.get();
            });
    ...
    var stateVisualElement = visualElement({
        ...
        makeTargetAnimatable: function (element, _a) {
            ...
            var origin = getOrigin(target, transition || {}, element);
            checkTargetForNewValues(element, target, origin);
            return __assign$2({ transition: transition, transitionEnd: transitionEnd }, target);
        },
    });
    ...
    function useAnimatedState(initialState) {
        ...
        React.useEffect(function () {
            element.setProps({
                onUpdate: function (v) { return setAnimationState(__assign$2({}, v)); },
            });
        });
